...
int main(void)
{
    ...
    std::string proj_param_file = "/home/issacs/texasinstruments/DLP-ALC-LIGHTCRAFTER-SDK-for-Ubuntu/examples/dlp_configures/projector_settings.txt";   // Path to the projector settings file (DLP)
    ...
    {
        sprintf(str,"/home/issacs/texasinstruments/DLP-ALC-LIGHTCRAFTER-SDK-for-Ubuntu/images/debug/GRAYCODE_ALBEDO_VERTICAL_600x400_%d.bmp",idx);
