...
ReturnCode OpenCV_Cam::Connect(const std::string &id){
    ...
    this->camera_.get(cv::CAP_PROP_FRAME_WIDTH);
    this->camera_.get(cv::CAP_PROP_FRAME_HEIGHT);
    this->camera_.get(cv::CAP_PROP_FPS);
    this->camera_.get(cv::CAP_PROP_BRIGHTNESS);
    this->camera_.get(cv::CAP_PROP_CONTRAST);
    this->camera_.get(cv::CAP_PROP_SATURATION);
    this->camera_.get(cv::CAP_PROP_HUE);
    this->camera_.get(cv::CAP_PROP_GAIN);
    this->camera_.get(cv::CAP_PROP_EXPOSURE);
